...
require(dirname(__FILE__) . '/admin/includes/lib_goods.php');
...
elseif ($action == 'act_add_message')
{
    ...
    $mst_text = trim($_POST['msg_title']) . trim($_POST['msg_content']);
    if (!textModeration($mst_text))
    {
        show_message($_LANG['message_content_unsafe'], $_LANG['message_list_lnk'], '', 'error');
    }
