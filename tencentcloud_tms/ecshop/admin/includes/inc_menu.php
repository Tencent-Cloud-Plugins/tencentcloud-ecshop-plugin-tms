...
$modules['19_tencent_plugins']['4tencent_ims']         = 'tencent_ims.php?act=list_edit';//图片内容安全配置
$modules['19_tencent_plugins']['5tencent_tms']         = 'tencent_tms.php?act=list_edit';//文本内容安全配置
