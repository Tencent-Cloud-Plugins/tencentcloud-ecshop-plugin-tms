...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if (function_exists('is_tms_enable') && is_tms_enable())
    {
        $check_text = $_POST['goods_name'];
        isset($_POST['goods_desc']) && $check_text .= $_POST['goods_desc'];
        isset($_POST['keywords']) && $check_text .= $_POST['keywords'];
        isset($_POST['goods_brief']) && $check_text .= $_POST['goods_brief'];
        if (!textModeration($check_text))
        {
            sys_msg($_LANG['good_content_unsafe'], 1, array(), false);
        }
    }
