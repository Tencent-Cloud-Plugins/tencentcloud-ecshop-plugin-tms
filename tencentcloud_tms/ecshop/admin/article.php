...
if ($_REQUEST['act'] == 'insert')
{
    ...
    /*文章内容安全检查*/
    $article_check_text = $_POST['title'];
    isset($_POST['author']) && $article_check_text .= $_POST['author'];
    isset($_POST['keywords']) && $article_check_text .= $_POST['keywords'];
    isset($_POST['description']) && $article_check_text .= $_POST['description'];
    isset($_POST['FCKeditor1']) && $article_check_text .= $_POST['FCKeditor1'];
    if (!textModeration($article_check_text))
    {
        sys_msg($_LANG['comment_content_unsafe']);
    }
